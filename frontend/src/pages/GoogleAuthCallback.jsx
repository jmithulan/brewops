...
const GoogleAuthCallback = () => {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        console.log('Processing Google OAuth callback', location);
        ...
        if (errorMsg) {
          console.error('Error from OAuth provider:', decodeURIComponent(errorMsg));
          const decodedError = decodeURIComponent(errorMsg);
          setError(`Authentication failed: ${decodedError}`);
          toast.error(`Google login failed: ${decodedError}`);
